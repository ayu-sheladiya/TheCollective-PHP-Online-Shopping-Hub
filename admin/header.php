...
// Ensure currency symbol is always defined
if (!defined('LANG_VALUE_1')) {
	define('LANG_VALUE_1', 'Rs. ');
}
...
<head>
	...
	<title>Collective | Admin Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Collective | Cothing Store</span>
			</a>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview <?php if (($cur_page == 'contact-message.php')) {
						echo 'active';
					} ?>">
