...
Transaction Details: <br>'.$row['bank_transaction_info'];
			elseif($row['payment_method'] == 'UPI'):
				$payment_details = '
UPI Transaction Info: <br>'.$row['bank_transaction_info'];
			elseif($row['payment_method'] == 'Cash On Delivery'):
			$payment_details = 'Cash on delivery order';
		else:
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		...
                        		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
								<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Transaction Information:</b> <br><?php echo $row['bank_transaction_info']; ?><br>                         	<?php elseif($row['payment_method'] == 'UPI'): ?>
                         		<b>Payment Method:</b> <?php echo '<span style="color:blue;"><b>'.$row['payment_method'].'</b></span>'; ?><br>
                         		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
						<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                         		<b>UPI Transaction Info:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                         	<?php elseif($row['payment_method'] == 'Cash On Delivery'): ?>
                         		...
                         		<b>Payment Id:</b> <?php echo $row['payment_id']; ?><br>
						<b>Date:</b> <?php echo $row['payment_date']; ?><br>
                         		<b>Note:</b> <?php echo 'Awaiting cash on delivery'; ?><br>                        	<?php endif; ?>
                        </td>
