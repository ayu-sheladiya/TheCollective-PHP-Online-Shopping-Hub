...
// Load contact details including map iframe from settings
$contact_map_iframe = '';
$contact_email = '';
$contact_phone = '';
$contact_address = '';
$statement = $pdo->prepare("SELECT contact_map_iframe, contact_email, contact_phone, contact_address FROM tbl_settings WHERE id=1");
$statement->execute();
...
';
        ...
        // Save to database
        $statement = $pdo->prepare("INSERT INTO tbl_contact_message (name, email, phone, message, datetime) VALUES (?, ?, ?, ?, ?)");
        $statement->execute(array($visitor_name, $visitor_email, $visitor_phone, $visitor_message, date('Y-m-d H:i:s')));
