...
<head>
	...
	if($cur_page == 'index.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		?>
		<title>Collective | <?php echo $meta_title_home; ?></title>
	...
	if($cur_page == 'about.php') {
		?>
		<title>Collective | <?php echo $about_meta_title; ?></title>
	...
	if($cur_page == 'faq.php') {
		?>
		<title>Collective | <?php echo $faq_meta_title; ?></title>
	...
	if($cur_page == 'contact.php') {
		?>
		<title>Collective | <?php echo $contact_meta_title; ?></title>
	...
	if($cur_page == 'dashboard.php') {
		?>
		<title>Collective | Dashboard</title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-profile-update.php') {
		?>
		<title>Collective | Update Profile</title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Collective | Update Billing and Shipping Info</title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	if($cur_page == 'customer-password-update.php') {
		?>
		<title>Collective | Update Password</title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
...
<?php // before_head injection disabled to remove embedded customer support chat widget ?>

</head>
<body>

<?php // after_body injection disabled to remove embedded customer support chat widget ?>
<!--
<div id="preloader">
	<div id="status"></div>
</div>-->
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="dashboard.php"><i class="fa fa-home"></i> My Profile</a></li>
						<?php
					} else {
						?>
