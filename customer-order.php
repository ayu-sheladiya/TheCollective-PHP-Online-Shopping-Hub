                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            foreach ($result1 as $row1) {
                                                ...
                                                echo 'Unit Price: '.LANG_VALUE_1.$row1['unit_price'];
                                                echo '<br><br>';
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <td>
                                            <a href="bill.php?payment_id=<?php echo $row['payment_id']; ?>" target="_blank">View Bill</a> | 
                                            <a href="bill.php?payment_id=<?php echo $row['payment_id']; ?>&download=1">Download PDF</a>
                                        </td>
                                    </tr>
                                    <?php
                                } 
