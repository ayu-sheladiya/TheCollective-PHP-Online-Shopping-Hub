        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT p.* FROM tbl_product p JOIN tbl_end_category e ON p.ecat_id=e.ecat_id JOIN tbl_mid_category m ON e.mcat_id=m.mcat_id WHERE p.ecat_id=? AND p.p_id!=?");
